...
.tcr-password-wrap2{position:relative}
.tcr-password-wrap2 input{padding-right:44px}
.tcr-password-eye2{position:absolute;right:10px;top:50%;transform:translateY(-50%);width:30px;height:30px;display:flex;align-items:center;justify-content:center;border:0;background:transparent;color:#64748B;cursor:pointer;border-radius:7px;padding:0}
.tcr-password-eye2:hover{background:#EEF4FA;color:#1A7FD4}
.tcr-password-eye2:focus-visible{outline:2px solid #1A7FD4;outline-offset:1px}
.tcr-password-eye2 svg{width:18px;height:18px;display:block}
          ...
          <div className="tcr-login-form2">
            ...
            <form onSubmit={submit} noValidate>
              ...
              <div className="tcr-login-field2">
                ...
                <div className="tcr-password-wrap2">
                  ...
                  <button type="button" className="tcr-password-eye2" onClick={() => setShowPassword(v => !v)} aria-label={showPassword ? 'Hide password' : 'Show password'} aria-pressed={showPassword}>
                    {showPassword ? (
                      ...
                      <svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2.5 12S6.5 6 12 6s9.5 6 9.5 6-4 6-9.5 6S2.5 12 2.5 12Z"/><circle cx="12" cy="12" r="2.5"/></svg>
                    )}
                  </button>
                </div>
              </div>
