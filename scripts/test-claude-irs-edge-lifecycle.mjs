...
const pullHandler=await load('supabase/functions/transcript-pull/index.ts',common)
const callbackHandler=await load('supabase/functions/transcript-pull-callback/index.ts',common)
...
console.log('PASS: Claude Edge lifecycle capabilities -> begin-session -> callback -> submit -> multi-result delivery')
