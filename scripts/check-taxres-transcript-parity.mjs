...
for(const n of [
  ...
  'sessionActive','Refresh Session','Session expires','Time remaining','userEmail'
]) need(session,n)
...
for(const n of [
  ...
  'Transcript Analysis','Pull Transcripts','POA / CAF Tracker','Session Status','Request History','Manual Upload (Fallback)',
...
for(const n of [
  ...
  'Manual PDF fallback',
  'TAX_YEARS',
  'Selected years valid',
  'POA On File',
  'SSN {maskedSsn(formClient.ssn)}',
  'id="irs-session-status"',
  'id="irs-request-history"',
  'id="irs-manual-fallback"',
  'onStatusChange={(st) =>',
  'directAvailable',
